...
<html>
<head>
  <?php $ui->showHeadHTML("New Return"); ?>
</head>
              ...
              <div class="col-md-12">
                  ...
                  <div class="form-group col-md-4">
                    ...
                    <div class="input-group date">
                      ...
                      <input type="text" value="<?php echo date('m/d/Y'); ?>" class="form-control pull-right" id="return_date">
                    </div>
                  </div>
                </div>
                <div class="col-md-12">
                ...
                <div class="form-group">
                  ...
                  <div class="col-md-12">
                      <button class="btn btn-lg btn-primary col-md-12 col-sm-12 col-xs-12" onclick="addReturn()">Add Return</button>
                  </div>
                </div>
              </div>
	        	</div>
  ...
  function addReturn(){
    ...
    for(let i=0;i<10;i++){
      if($('.particulars')[i].value != "-1")
		...
		$.ajax({
        url: '../gateway/adps.php?op=addReturn',
        type: 'post',
        dataType: 'json',
        data: {'user_id':1,
